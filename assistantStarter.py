...
assistant = client.beta.assistants.retrieve(assistant_id="asst_IGem2dehhudk94s9ffveO4iR")
# print(assistant)

vector_store_files = client.vector_stores.files.list(
    vector_store_id = "vs_682ffadf5960819185a0e6e3ddad9ad0"
)
...
while True:
    if (user_input == ""):
        ...
        name = input("You: ")
        print("\nAssistant: Hey, "+ name + "! How can I help you?\n")
